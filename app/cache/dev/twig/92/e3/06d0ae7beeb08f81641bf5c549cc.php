...
";
    ...
    <li>
        <a href=\"";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tacherdi"), "html", null, true);
        echo "\">
            Back to the list
        </a>
    </li>
...
";
    ...
    {
        return array (  65 => 23,  60 => 21,  52 => 16,  41 => 8,  34 => 6,  30 => 4,  24 => 3,  20 => 1,);
    }
}
