...
/* EspritUserBundle:EspConges:show.html.twig */
class __TwigTemplate_b6105b1f0bfc36aefdb7c6a73a621ee7 extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 29
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("espconges"), "html", null, true);
        echo "\">
            Back to the list
        </a>
    </li>
    ...
    <li>
        <form action=\"";
        // line 39
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("espconges_delete", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\">
...
";
    ...
    {
        return "EspritUserBundle:EspConges:show.html.twig";
    }
