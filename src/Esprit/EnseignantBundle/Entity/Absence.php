...
class Absence {
     ...
     * @ORM\JoinColumn(name="enseignant_id", referencedColumnName="id_ens")
     */
    private $enseignant;
     ...
     * @ORM\JoinColumn(name="etudiant_id", referencedColumnName="id_et")
     */
    private $etudiant;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="annee_deb", type="date", nullable=true)
     */
    private $anneeDeb;
     ...
     * @var string
     *
     * @ORM\Column(name="heureAbsence", type="string", length=255,nullable=true)
     */
